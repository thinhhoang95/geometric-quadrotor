...
% Jacobian for the landmark height constraints
Jl = [];
for lml=1:num_of_landmarks
    Jlrow = [];
    for vy=1:9*(window_size-1)+lml*3-1
        Jlrow = [Jlrow 0];
    end
    Jlrow = [Jlrow 1];
    for vy=9*(window_size-1)+lml*3+1:9*(window_size-1)+num_of_landmarks*3
        Jlrow = [Jlrow 0];
    end
    Jl = [Jl; Jlrow];
end
