    ...
    for lm=1:num_of_landmarks
        ...
        switch lm
            ...
            case 3
                lmip_m = feature2.Data(cam_sample,:); % measurement of landmark at the currennt keyframe time
            case 4
                lmip_m = feature3.Data(cam_sample,:);
            case 5
                lmip_m = feature4.Data(cam_sample,:);
            case 6
                lmip_m = feature5.Data(cam_sample,:);
        end
        xyzlm = Rt(:,:,i)'*(Lt(lm,:) - Pt(i,:))';
        lmip_m = focal_length*[xyzlm(1)/xyzlm(3) xyzlm(2)/xyzlm(3)];
        ephoto = lmip - lmip_m;
