...
window_size = 2; % sliding window length
imu_sampling_time = 0.02; % sampling time of IMU data
focal_length = 0.024; % focal length is 24mm
num_of_landmarks = 0;
residual_vector_length = window_size * 9 + 3 * num_of_landmarks; % 3 is the number of observing landmarks
gn_iterations = 12; % num of iterations per Gauss-Newton loop
