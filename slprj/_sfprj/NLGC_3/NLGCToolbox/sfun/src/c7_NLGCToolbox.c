...
static const char * c7_debug_family_names[14] = { "force", "gamma", "omega_sq",
  "omega", "nargin", "nargout", "f", "M", "Ct", "dctcq", "o1", "o2", "o3", "o4"
};

/* Function Declarations */
static void initialize_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
static void initialize_params_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
static void enable_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct *chartInstance);
static void disable_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_NLGCToolbox
  (SFc7_NLGCToolboxInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_NLGCToolbox
  (SFc7_NLGCToolboxInstanceStruct *chartInstance);
static void set_sim_state_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c7_st);
static void finalize_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
static void sf_gateway_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
static void mdl_start_c7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
static void initSimStructsc7_NLGCToolbox(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct *chartInstance,
  const mxArray *c7_b_o4, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[12]);
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct *chartInstance,
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct *chartInstance,
...
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static void c7_mldivide(SFc7_NLGCToolboxInstanceStruct *chartInstance, real_T
  c7_A[16], real_T c7_B[4], real_T c7_Y[4]);
static void c7_check_forloop_overflow_error(SFc7_NLGCToolboxInstanceStruct
  *chartInstance, boolean_T c7_overflow);
static void c7_warning(SFc7_NLGCToolboxInstanceStruct *chartInstance);
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_NLGCToolbox, const char_T
  *c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_mldivide(SFc7_NLGCToolboxInstanceStruct *chartInstance, real_T
  c7_A[16], real_T c7_B[4]);
static void init_dsm_address_info(SFc7_NLGCToolboxInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc7_NLGCToolboxInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc7_NLGCToolbox(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c7_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c7_is_active_c7_NLGCToolbox = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T c7_dv0[12];
  int32_T c7_i0;
  sf_mex_import_named("Ct", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c7_d0, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c7_Ct = c7_d0;
  sf_mex_import_named("dctcq", sf_mex_get_sfun_param(chartInstance->S, 1, 0),
                      c7_dv0, 0, 0, 0U, 1, 0U, 2, 3, 4);
  for (c7_i0 = 0; c7_i0 < 12; c7_i0++) {
    chartInstance->c7_dctcq[c7_i0] = c7_dv0[c7_i0];
  }
}
  ...
  (SFc7_NLGCToolboxInstanceStruct *chartInstance)
{
  ...
  c7_e_hoistedGlobal = chartInstance->c7_is_active_c7_NLGCToolbox;
  c7_f_y = NULL;
  ...
  *chartInstance, const mxArray *c7_st)
{
  ...
  *chartInstance->c7_o4 = c7_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c7_is_active_c7_NLGCToolbox = c7_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 4)),
     "is_active_c7_NLGCToolbox");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_NLGCToolbox(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c7_b_dctcq[12];
  real_T c7_force[4];
  real_T c7_gamma[16];
  real_T c7_omega_sq[4];
  real_T c7_omega[4];
  ...
  for (c7_i1 = 0; c7_i1 < 3; c7_i1++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c7_M)[c7_i1], 1U);
  }
  ...
  for (c7_i2 = 0; c7_i2 < 3; c7_i2++) {
    c7_b_M[c7_i2] = (*chartInstance->c7_M)[c7_i2];
  }

  c7_b_Ct = chartInstance->c7_Ct;
  for (c7_i3 = 0; c7_i3 < 12; c7_i3++) {
    c7_b_dctcq[c7_i3] = chartInstance->c7_dctcq[c7_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c7_debug_family_names,
    c7_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_force, 0U, c7_d_sf_marshallOut,
    c7_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_gamma, 1U, c7_e_sf_marshallOut,
    c7_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_omega_sq, 2U, c7_d_sf_marshallOut,
    c7_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_omega, 3U, c7_d_sf_marshallOut,
    c7_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_nargout, 5U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_f, 6U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c7_b_M, 7U, c7_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_Ct, 8U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_b_dctcq, 9U, c7_b_sf_marshallOut,
    c7_b_sf_marshallIn);
  ...
  for (c7_i7 = 0; c7_i7 < 4; c7_i7++) {
    for (c7_i8 = 0; c7_i8 < 3; c7_i8++) {
      c7_gamma[(c7_i8 + c7_i5) + 1] = c7_b_dctcq[c7_i8 + c7_i6];
    }
  ...
  for (c7_i9 = 0; c7_i9 < 4; c7_i9++) {
    c7_dv1[c7_i9] = c7_force[c7_i9];
  }

  for (c7_i10 = 0; c7_i10 < 16; c7_i10++) {
    c7_b_gamma[c7_i10] = c7_gamma[c7_i10];
  }

  c7_b_mldivide(chartInstance, c7_b_gamma, c7_dv1);
  for (c7_i11 = 0; c7_i11 < 4; c7_i11++) {
    c7_omega_sq[c7_i11] = c7_dv1[c7_i11];
  }

  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, 6);
  for (c7_i12 = 0; c7_i12 < 4; c7_i12++) {
    c7_omega[c7_i12] = (real_T)(c7_omega_sq[c7_i12] > 0.0) * c7_omega_sq[c7_i12]
      + ((real_T)(c7_omega_sq[c7_i12] <= 0.0) + 5.05);
  }
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_NLGCToolboxInstanceStruct *chartInstance;
  chartInstance = (SFc7_NLGCToolboxInstanceStruct *)chartInstanceVoid;
  ...
  *c7_inData)
{
  ...
  for (c7_i14 = 0; c7_i14 < 4; c7_i14++) {
    for (c7_i15 = 0; c7_i15 < 3; c7_i15++) {
      c7_u[c7_i15 + c7_i13] = (*(real_T (*)[12])c7_inData)[c7_i15 + c7_i13];
    }
  ...
  c7_y = NULL;
  sf_mex_assign(&c7_y, sf_mex_create("y", c7_u, 0, 0U, 1U, 0U, 2, 3, 4), false);
  sf_mex_assign(&c7_mxArrayOutData, c7_y, false);
  return c7_mxArrayOutData;
}
  ...
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[12])
{
  ...
  int32_T c7_i16;
  (void)chartInstance;
  sf_mex_import(c7_parentId, sf_mex_dup(c7_u), c7_dv2, 1, 0, 0U, 1, 0U, 2, 3, 4);
  for (c7_i16 = 0; c7_i16 < 12; c7_i16++) {
    c7_y[c7_i16] = c7_dv2[c7_i16];
  }
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  SFc7_NLGCToolboxInstanceStruct *chartInstance;
  chartInstance = (SFc7_NLGCToolboxInstanceStruct *)chartInstanceVoid;
  c7_b_dctcq = sf_mex_dup(c7_mxArrayInData);
  c7_thisId.fIdentifier = (const char *)c7_varName;
  c7_thisId.fParent = NULL;
  c7_thisId.bParentIsCell = false;
  c7_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_b_dctcq), &c7_thisId, c7_y);
  sf_mex_destroy(&c7_b_dctcq);
  c7_i17 = 0;
  for (c7_i18 = 0; c7_i18 < 4; c7_i18++) {
    for (c7_i19 = 0; c7_i19 < 3; c7_i19++) {
      (*(real_T (*)[12])c7_outData)[c7_i19 + c7_i17] = c7_y[c7_i19 + c7_i17];
    }
  ...
  *c7_inData)
{
  ...
  for (c7_i20 = 0; c7_i20 < 3; c7_i20++) {
    c7_u[c7_i20] = (*(real_T (*)[3])c7_inData)[c7_i20];
  }
  ...
  *c7_inData)
{
  ...
  for (c7_i21 = 0; c7_i21 < 4; c7_i21++) {
    c7_u[c7_i21] = (*(real_T (*)[4])c7_inData)[c7_i21];
  }
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  c7_thisId.fParent = NULL;
  c7_thisId.bParentIsCell = false;
  c7_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_omega), &c7_thisId, c7_y);
  ...
  *c7_inData)
{
  ...
  for (c7_i25 = 0; c7_i25 < 4; c7_i25++) {
    for (c7_i26 = 0; c7_i26 < 4; c7_i26++) {
      c7_u[c7_i26 + c7_i24] = (*(real_T (*)[16])c7_inData)[c7_i26 + c7_i24];
    }
  ...
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[16])
{
  ...
  int32_T c7_i27;
  (void)chartInstance;
  sf_mex_import(c7_parentId, sf_mex_dup(c7_u), c7_dv4, 1, 0, 0U, 1, 0U, 2, 4, 4);
  for (c7_i27 = 0; c7_i27 < 16; c7_i27++) {
    c7_y[c7_i27] = c7_dv4[c7_i27];
  }
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  c7_thisId.fParent = NULL;
  c7_thisId.bParentIsCell = false;
  c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_gamma), &c7_thisId, c7_y);
  sf_mex_destroy(&c7_gamma);
  c7_i28 = 0;
  for (c7_i29 = 0; c7_i29 < 4; c7_i29++) {
    for (c7_i30 = 0; c7_i30 < 4; c7_i30++) {
      (*(real_T (*)[16])c7_outData)[c7_i30 + c7_i28] = c7_y[c7_i30 + c7_i28];
    }
...
const mxArray *sf_c7_NLGCToolbox_get_eml_resolved_functions_info(void)
{
  ...
  c7_A[16], real_T c7_B[4], real_T c7_Y[4])
{
  ...
  for (c7_i31 = 0; c7_i31 < 4; c7_i31++) {
    c7_Y[c7_i31] = c7_B[c7_i31];
  }

  for (c7_i32 = 0; c7_i32 < 16; c7_i32++) {
    c7_b_A[c7_i32] = c7_A[c7_i32];
  }
  ...
  *c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_NLGCToolbox), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_NLGCToolbox);
  return c7_y;
}
  ...
  c7_A[16], real_T c7_B[4])
{
  ...
  int32_T c7_c_i;
  int32_T c7_ijA;
  for (c7_i34 = 0; c7_i34 < 16; c7_i34++) {
    c7_b_A[c7_i34] = c7_A[c7_i34];
  }

  for (c7_i35 = 0; c7_i35 < 4; c7_i35++) {
    c7_ipiv[c7_i35] = 1 + c7_i35;
  }
...
void sf_c7_NLGCToolbox_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2801879053U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2606572384U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1417990189U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2822403799U);
}

mxArray* sf_c7_NLGCToolbox_get_post_codegen_info(void);
mxArray *sf_c7_NLGCToolbox_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("vi6GPix1JudWkWKnSOVbyE");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_NLGCToolbox_get_post_codegen_info();
...
mxArray *sf_c7_NLGCToolbox_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_NLGCToolbox_jit_fallback_info(void)
{
...
mxArray *sf_c7_NLGCToolbox_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_NLGCToolbox(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"o1\",},{M[1],M[9],T\"o2\",},{M[1],M[10],T\"o3\",},{M[1],M[11],T\"o4\",},{M[8],M[0],T\"is_active_c7_NLGCToolbox\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_NLGCToolbox_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_NLGCToolboxInstanceStruct *chartInstance =
      (SFc7_NLGCToolboxInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(6,10,0,0,"Ct");
          _SFD_SET_DATA_PROPS(7,10,0,0,"dctcq");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(6U, (void *)&chartInstance->c7_Ct);
        _SFD_SET_DATA_VALUE_PTR(7U, (void *)&chartInstance->c7_dctcq);
      }
    }
  }
}
...
{
  return "sZSEx9PDGcZD1v2sDsNl3f";
}

static void sf_opaque_initialize_c7_NLGCToolbox(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*)
    chartInstanceVar);
  initialize_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_NLGCToolbox(void *chartInstanceVar)
{
  enable_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_NLGCToolbox(void *chartInstanceVar)
{
  disable_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_NLGCToolbox(void *chartInstanceVar)
{
  sf_gateway_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_NLGCToolbox(SimStruct* S)
{
  return get_sim_state_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_NLGCToolbox(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c7_NLGCToolbox(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_NLGCToolbox_optimization_info();
    }

    finalize_c7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_NLGCToolbox((SFc7_NLGCToolboxInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_NLGCToolbox(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_NLGCToolbox(SimStruct *S)
{
  /* Actual parameters from chart:
     Ct dctcq
   */
  const char_T *rtParamNames[] = { "Ct", "dctcq" };
  ...
  ssSetChecksum0(S,(3007230327U));
  ssSetChecksum1(S,(1750473391U));
  ssSetChecksum2(S,(1659120181U));
  ssSetChecksum3(S,(111694062U));
...
static void mdlRTW_c7_NLGCToolbox(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_NLGCToolbox(SimStruct *S)
{
  SFc7_NLGCToolboxInstanceStruct *chartInstance;
  chartInstance = (SFc7_NLGCToolboxInstanceStruct *)utMalloc(sizeof
    (SFc7_NLGCToolboxInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc7_NLGCToolboxInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_NLGCToolbox;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_NLGCToolbox;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_NLGCToolbox;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_NLGCToolbox;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_NLGCToolbox;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_NLGCToolbox;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_NLGCToolbox;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_NLGCToolbox;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_NLGCToolbox;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_NLGCToolbox;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_NLGCToolbox;
  ...
  mdl_start_c7_NLGCToolbox(chartInstance);
}

void c7_NLGCToolbox_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_NLGCToolbox(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_NLGCToolbox(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_NLGCToolbox(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_NLGCToolbox_method_dispatcher.\n"
