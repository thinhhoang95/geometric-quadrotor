#ifndef __c1_NLGC_2_h__
#define __c1_NLGC_2_h__
...
#ifndef typedef_SFc1_NLGC_2InstanceStruct
#define typedef_SFc1_NLGC_2InstanceStruct
...
typedef struct {
  ...
  uint8_T c1_is_active_c1_NLGC_2;
  real_T c1_kx;
  real_T c1_kv;
  ...
  real_T *c1_dbg_simtime;
  real_T (*c1_dbg_desiredthrust)[3];
} SFc1_NLGC_2InstanceStruct;

#endif                                 /*typedef_SFc1_NLGC_2InstanceStruct*/
...
extern const mxArray *sf_c1_NLGC_2_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c1_NLGC_2_get_check_sum(mxArray *plhs[]);
extern void c1_NLGC_2_method_dispatcher(SimStruct *S, int_T method, void *data);
