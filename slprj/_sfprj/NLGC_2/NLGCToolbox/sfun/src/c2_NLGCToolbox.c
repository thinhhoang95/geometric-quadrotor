...
static void initialize_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
static void initialize_params_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
static void enable_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct *chartInstance);
static void disable_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_NLGCToolbox
  (SFc2_NLGCToolboxInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_NLGCToolbox
  (SFc2_NLGCToolboxInstanceStruct *chartInstance);
static void set_sim_state_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
static void sf_gateway_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
static void mdl_start_c2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
static void initSimStructsc2_NLGCToolbox(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct *chartInstance,
  const mxArray *c2_b_moment, const char_T *c2_identifier, real_T c2_y[3]);
static void c2_b_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[9]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_NLGCToolbox, const char_T
  *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_NLGCToolboxInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_NLGCToolboxInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_NLGCToolboxInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_NLGCToolbox(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c2_is_active_c2_NLGCToolbox = 0U;
}
  ...
  (SFc2_NLGCToolboxInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_NLGCToolbox;
  c2_c_y = NULL;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_NLGCToolbox = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_NLGCToolbox");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_NLGCToolbox(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[3];
  SFc2_NLGCToolboxInstanceStruct *chartInstance;
  chartInstance = (SFc2_NLGCToolboxInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_NLGCToolbox_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  const char * c2_data[4] = {
    "789cc592c14ac3401086a7da163d283df9180651103cd9d6c616da58357a11a9693235d1ecae6c7625be850fe00378f74d3cf83ca64dd2a4812542b50e2c939f"
    "3f3bdfecee40a537a800c076b46ad17aadc32cb6e2048d24afc16214fd8a22a75183eac2bed47f4bb2cda8c050c4c2f7281a928c9147825a04e7651c463c6a51",
    "61be3c21700c98ff8ccecc99783e9a1ec13ecb89ae1709a2e7acb9985ad3efb68bf6e3a524c0dd206bd7cf0bc8ddcf9de2fcd592fb2946f17e8aff95f1ea25bc"
    "b2f7d8848dbc3c5ef67c69fd7505af9138ae15bff16ff1ea059df162c76172ec63c67b5f92d755f216fd9bce6dfb48bb0a90079acb2c7aaf0d9a66bfd9d2869c",
    "3da02d02cde89fb6a3a1e7cc1f9d4bcbe14c303edad374496de1311a6db3c42e59e11c7c5e7c7c35573c77ab9ef37fe3858a7a3f9dbb1d05af51f00f74571269"
    "4f7afb9d1e3d0b8d9673786d9f647d0c4b38657d8042ff75fd6f548b5cee", "" };
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_NLGCToolbox), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_NLGCToolbox);
  return c2_y;
}
...
void sf_c2_NLGCToolbox_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2507378826U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1995541250U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3638630750U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2602958728U);
}

mxArray* sf_c2_NLGCToolbox_get_post_codegen_info(void);
mxArray *sf_c2_NLGCToolbox_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ndNWMMPWTfmGuZrmlZCyyD");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_NLGCToolbox_get_post_codegen_info();
...
mxArray *sf_c2_NLGCToolbox_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_NLGCToolbox_jit_fallback_info(void)
{
...
mxArray *sf_c2_NLGCToolbox_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_NLGCToolbox(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"moment\",},{M[8],M[0],T\"is_active_c2_NLGCToolbox\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_NLGCToolbox_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_NLGCToolboxInstanceStruct *chartInstance =
      (SFc2_NLGCToolboxInstanceStruct *)sf_get_chart_instance_ptr(S);
...
{
  return "sgoOr3vlvIjymHy2IaFIZjF";
}

static void sf_opaque_initialize_c2_NLGCToolbox(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*)
    chartInstanceVar);
  initialize_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_NLGCToolbox(void *chartInstanceVar)
{
  enable_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_NLGCToolbox(void *chartInstanceVar)
{
  disable_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_NLGCToolbox(void *chartInstanceVar)
{
  sf_gateway_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_NLGCToolbox(SimStruct* S)
{
  return get_sim_state_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_NLGCToolbox(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_NLGCToolbox(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_NLGCToolbox_optimization_info();
    }

    finalize_c2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_NLGCToolbox((SFc2_NLGCToolboxInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_NLGCToolbox(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_NLGCToolbox(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1708225483U));
  ssSetChecksum1(S,(376407715U));
  ssSetChecksum2(S,(2509765636U));
  ssSetChecksum3(S,(2513891507U));
...
static void mdlRTW_c2_NLGCToolbox(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_NLGCToolbox(SimStruct *S)
{
  SFc2_NLGCToolboxInstanceStruct *chartInstance;
  chartInstance = (SFc2_NLGCToolboxInstanceStruct *)utMalloc(sizeof
    (SFc2_NLGCToolboxInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_NLGCToolboxInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_NLGCToolbox;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_NLGCToolbox;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_NLGCToolbox;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_NLGCToolbox;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_NLGCToolbox;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_NLGCToolbox;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_NLGCToolbox;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_NLGCToolbox;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_NLGCToolbox;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_NLGCToolbox;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_NLGCToolbox;
  ...
  mdl_start_c2_NLGCToolbox(chartInstance);
}

void c2_NLGCToolbox_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_NLGCToolbox(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_NLGCToolbox(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_NLGCToolbox(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_NLGCToolbox_method_dispatcher.\n"
