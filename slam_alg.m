...
% Parameters
kf_interval_imu = 20; % 20 IMU samples for 1 keyframe
kf_interval_cam = 20; % 20 camera samples for 1 keyframe
...
residual_vector_length = window_size * 9 + 3; % which is 48, in case window_size = 5
gn_iterations = 7; % num of iterations per Gauss-Newton loop
